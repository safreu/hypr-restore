...
#[command(about = "Manage the hypr-restore functionality.")]
struct Cli {
    #[clap(subcommand)]
...
/// Execute the hypr-restore command with given Arguments
