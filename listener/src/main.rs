...
use std::io::{BufRead};
use path_tracker::ExecutablesMap;
...
fn main() -> std::io::Result<()> {
    ...
    let mut executables_handler = ExecutablesMap::new(shared::EXECUTABLE_PATH);
        ...
        match line {
            Ok(line) => {
                ...
                if line.contains("openwindow") {
                    ...
                    match ExecutablesMap::get_executable_path_from_env(&event.address()) {
